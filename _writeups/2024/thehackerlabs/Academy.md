...
![](/assets/images/thl/academy/1.png)
...
We get the password of the user `dylan`, we are going to access the admin panel:

![](/assets/images/thl/academy/2.png)

We will be able to see that we have a plugin called `Bit File Manager` where we will be able to upload a `.php` file with a phppentestmonkey:
...
![](/assets/images/thl/academy/3.png)
